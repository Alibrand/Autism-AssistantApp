...
import com.ksacp2022t3.fanarapp.adapters.SentRequestsListAdapter;
...
public class SentRequestsActivity extends AppCompatActivity {
    ...
    void load_requests(){
        ...
        firestore.collection("requests")
                .whereEqualTo("sender_id",firebaseAuth.getUid())
                ...
                .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                    ...
                    public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                        ...
                        SentRequestsListAdapter adapter=new SentRequestsListAdapter(requestList,SentRequestsActivity.this);
                    ...
                    public void onFailure(@NonNull Exception e) {
                        progressDialog.dismiss();
                        Toast.makeText(SentRequestsActivity.this,"Error :"+e.getMessage() , Toast.LENGTH_LONG).show();
                        finish();
